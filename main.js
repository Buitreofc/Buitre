...
global.reloadHandler = async function(restatConn) {
  ...
  conn.welcome = '*╔══════════════*\n*╟❧ @subject*\n*╠══════════════*\n*╟❧ @user*\n*╟❧ 𝗕𝗜𝗘𝗡𝗩𝗘𝗡𝗜𝗗𝗢/𝗔* 𝗗𝗜𝗦𝗙𝗥𝗨𝗧𝗔 𝗧𝗨 𝗘𝗦𝗧𝗔𝗗𝗜𝗔 𝗔𝗧𝗧: 𝗕𝗨𝗜𝗧𝗥𝗘 𝗢𝗙𝗖🎅🏼🎁!*\n*╚══════════════*';
  conn.bye = '*╔══════════════*\n*╟❧ @user*\n*╟❧ 𝗛𝗔𝗦𝗧𝗔 𝗟𝗨𝗘𝗚𝗢‚ 𝗔𝗧𝗧: 𝗕𝗨𝗜𝗧𝗥𝗘 𝗢𝗙𝗖 ☃️🎁* \n*╚══════════════*';
  conn.spromote = '*@user 𝐅𝐞𝐥𝐢𝐜𝐢𝐝𝐚𝐝𝐞𝐬 𝐚𝐡𝐨𝐫𝐚 𝐞𝐫𝐞𝐬 𝐚𝐝𝐦𝐢𝐧 𝐝𝐞𝐥 𝐠𝐫𝐮𝐩𝐨 👑*';
  conn.sdemote = '*@user 𝐀𝐛𝐚𝐧𝐝𝐨𝐧𝐚 𝐞𝐥 𝐠𝐫𝐮𝐩𝐨 𝐝𝐞 𝐚𝐝𝐦𝐢𝐧𝐬!*';
...
setInterval(async () => {
  ...
  const bio = `🎅🏼𝐁𝐔𝐈𝐓𝐑𝐄 𝐁𝐎𝐓 𝐀𝐂𝐓𝐈𝐕𝐎: ${uptime} ┃ 𝐅𝐄𝐋𝐈𝐙 𝐍𝐀𝐕𝐈𝐃𝐀𝐃 👑 ʙᴏᴛ ʙʏ @ɪᴀᴍʙᴜɪᴛʀᴇ ┃ 🔗 ᴄᴜᴇɴᴛᴀs ᴏғᴄ: http://buitre.boxmineworld.com`;
