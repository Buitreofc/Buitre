...
**/
    ...
    if ((isMedia && quoted.mtype === 'imageMessage') && htextos) {
      ...
      await conn.relayMessage(m.chat, {extendedTextMessage: {text: `${masss}\n${htextos}\n`, ...{contextInfo: {mentionedJid: users, externalAdReply: {thumbnail: imagen1, sourceUrl: 'https://www.instagram.com/iambuitre?igshid=ZGNjOWZkYTE3MQ=='}}}}}, {});
    }
  }
};
handler.command = /^(hidetag|avisar|notificar|notify)$/i;
handler.group = true;
handler.admin = true;
